...
CREATE TABLE `orders` (
  ...
  `decoup` varchar(255) NOT NULL,
  `lers` varchar(255) NOT NULL,
  `livr` varchar(255) NOT NULL,
  `avc` varchar(255) NOT NULL,
  `res` varchar(255) NOT NULL,
  `espes` varchar(255) NOT NULL,
...
CREATE TABLE `products` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `qty_r` varchar(255) NOT NULL,
  
  `price` varchar(255) NOT NULL,
  `price_m` varchar(255) NOT NULL,
  `price_v` varchar(255) NOT NULL,
  `qty` float NOT NULL ,
  `image` text NOT NULL,
