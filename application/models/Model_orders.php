...
class Model_orders extends CI_Model
{
	...
	public function create()
	{
    	...
    	$data = array(
			...
			'decoup' => $this->input->post('decoup'),
			'lers' => $this->input->post('lers'),
			'livr' => $this->input->post('livr'),
			'avc' => $this->input->post('avc'),
			'res' => $this->input->post('res'),
			'espes' => $this->input->post('espes'),
			'chek' => $this->input->post('chek'),
			'effet' => $this->input->post('effet'),
    	...
    	for($x = 0; $x < $count_product; $x++) {
    		...
    		$qty = (float) $product_data['qty'] - (float) $this->input->post('qty')[$x];
