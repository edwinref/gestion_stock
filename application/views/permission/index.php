  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Autorisation</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createGroup', $user_permission)): ?>
            <a href="<?php echo base_url('Controller_Permission/create') ?>" class="btn btn-primary">Ajouter autorisation</a>
            <br /> <br />
          <?php endif; ?>

          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Gérer l'autorisation</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
