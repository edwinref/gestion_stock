  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">        
          <li><a href="<?php echo base_url('Controller_Permission/') ?>">Autorisation</a></li></li>
      </ol>
    </section>
            ...
            <form role="form" action="<?php base_url('Controller_Permission/create') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="group_name" name="group_name" placeholder="Entrer le nom de l'autorisation ">
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary">Sauvegarder 1 fermer</button>
