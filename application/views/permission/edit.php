  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('Controller_Permission/') ?>">Autorisation</a></li>
            ...
            <form role="form" action="<?php base_url('Controller_Permission/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="group_name">Nom de l'autorisation</label>
                ...
                <div class="form-group">
                  <label for="permission">Autorisation</label>
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary">Mettre à jour  & fermer</button>
                <a href="<?php echo base_url('Controller_Permission/') ?>" class="btn btn-warning">Retour</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
