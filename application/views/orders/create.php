        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('Controller_Orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Heure:  <?php date_default_timezone_set("Africa/Casablanca");echo date('h:i a') ?></label>
                </div>
                ...
                <div class="col-md-7 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Entrer nom du client" autocomplete="off" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <textarea type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Entrer adresss" autocomplete="off"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Entrer numero telephone" autocomplete="off">
                    </div>
                  </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="decoup" name="decoup" placeholder="Entrer découpage" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="lers" name="lers" placeholder="Entrer gharghar" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label"> Charge <?php echo $company_data['service_charge_value'] ?> DH </label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="livr" name="livr" placeholder="Entrer prix de livraison" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="avc" name="avc" placeholder="Entrer L'Avence" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="res" name="res" placeholder="Entrer le reste d'avence" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="espes" name="espes" placeholder="Entrer L'Espéce" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="chek" name="chek" placeholder="Entrer chéque" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="effet" name="effet" placeholder="Entrer l'Effect " onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="discount" name="discount" placeholder="Entrer remise" onkeyup="subAmount()" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
